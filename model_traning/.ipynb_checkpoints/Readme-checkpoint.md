...
1. **OverallQual:** Ogólna jakość materiałów i wykończenia.
2. **GrLivArea:** Powierzchnia mieszkalna nad poziomem gruntu.
3. **Neighborhood:** Lokalizacja nieruchomości.
4. **Total_flor_SF / GarageArea:** Powierzchnia użytkowa i garażowa.